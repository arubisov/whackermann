...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(125048679U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3868243887U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3789231316U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(748522410U);
}
...
mxArray *sf_c3_driver_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("rrbx2BJMGlbc3kPHPi7d8C");
...
static void mdlSetWorkWidths_c3_driver(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(183817102U));
  ssSetChecksum1(S,(4196529578U));
  ssSetChecksum2(S,(3998264077U));
  ssSetChecksum3(S,(2805693872U));
