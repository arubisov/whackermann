#ifndef __c4_driver_h__
#define __c4_driver_h__
...
#ifndef typedef_SFc4_driverInstanceStruct
#define typedef_SFc4_driverInstanceStruct
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_driver;
} SFc4_driverInstanceStruct;

#endif                                 /*typedef_SFc4_driverInstanceStruct*/
...
extern void c4_driver_method_dispatcher(SimStruct *S, int_T method, void *data);
