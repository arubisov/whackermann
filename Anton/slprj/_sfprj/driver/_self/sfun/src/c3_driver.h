#ifndef __c3_driver_h__
#define __c3_driver_h__
...
#ifndef typedef_SFc3_driverInstanceStruct
#define typedef_SFc3_driverInstanceStruct
...
typedef struct {
  ...
  uint8_T c3_is_active_c3_driver;
} SFc3_driverInstanceStruct;

#endif                                 /*typedef_SFc3_driverInstanceStruct*/
...
extern void c3_driver_method_dispatcher(SimStruct *S, int_T method, void *data);
